				...
				<s:iterator value="products" status="rowstatus">
					...
					<s:if test="#rowstatus.odd == true">
						...
						<td class="odd"><s:property value="categoryName" /></td>
										<td class="odd"><a href="./ProductDetailsAction.action?id=<s:property value='productId'/>&searchValue=<s:property value='searchValue'/>&searchMinPrice=<s:property value='searchMinPrice'/>&searchMaxPrice=<s:property value='searchMaxPrice'/>"><img src="img/detBtn.png" alt="<s:text name="product.details" />"/></a></td>
					...
					<s:else>
						...
						<td><s:property value="categoryName" /></td>
										<td><a href="./ProductDetailsAction.action?id=<s:property value='productId'/>&searchValue=<s:property value='searchValue'/>&searchMinPrice=<s:property value='searchMinPrice'/>&searchMaxPrice=<s:property value='searchMaxPrice'/>"><img src="img/detBtn.png" alt="<s:text name="product.details" />"/></a></td>
						<s:if test="#session.webshop_user.role.level==0">
