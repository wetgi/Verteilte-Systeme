...
public interface ProductsApi {
	...
	@ApiOperation(value = "All products", notes = "", response = Product.class, responseContainer = "List", authorizations = {
			@Authorization(value = "UserSecurity") }, tags = { "product", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "An array of product", response = Product.class),
	...
	@ApiOperation(value = "Creates a new product.", notes = "", response = Product.class, authorizations = {
			@Authorization(value = "AdminSecurity") }, tags = { "product", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Created the product.", response = Product.class),
	...
	@RequestMapping(value = "/products/{productId}", produces = { "application/json" }, method = RequestMethod.DELETE)
	...
	@ApiOperation(value = "Get details to a certain product.", notes = "", response = Product.class, authorizations = {
			@Authorization(value = "UserSecurity") }, tags = { "product", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Returns the product", response = Product.class),
