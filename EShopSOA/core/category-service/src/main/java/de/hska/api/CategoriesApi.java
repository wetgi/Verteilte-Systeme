...
public interface CategoriesApi {
	...
	@ApiOperation(value = "Delete a certain category.", notes = "", response = Void.class, authorizations = {
			@Authorization(value = "AdminSecurity") }, tags = { "category", })
	...
	@RequestMapping(value = "/categories/{categoryId}", produces = {
			"application/json" }, method = RequestMethod.DELETE)
	ResponseEntity<Void> categoriesCategoryIdDelete(
	...
	@ApiOperation(value = "Get details to a certain category.", notes = "", response = Category.class, authorizations = {
			@Authorization(value = "UserSecurity") }, tags = { "category", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Returns the category", response = Category.class),
			@ApiResponse(code = 404, message = "Category not found", response = Category.class) })
	@RequestMapping(value = "/categories/{categoryId}", produces = { "application/json" }, method = RequestMethod.GET)
	ResponseEntity<Category> categoriesCategoryIdGet(
	...
	@ApiOperation(value = "All categories", notes = "", response = Category.class, responseContainer = "List", authorizations = {
			@Authorization(value = "UserSecurity") }, tags = { "category", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "An array of categories", response = Category.class),
	...
	@ApiOperation(value = "Creates a new category.", notes = "", response = Category.class, authorizations = {
			@Authorization(value = "AdminSecurity") }, tags = { "category", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Created the category.", response = Category.class),
